...
export default function AboutMe() {
  return (
    <div className="flex bg-cyan-800 text-slate-50 text-left py-4 lg:px-[10%] px-[8%] ">
      <div className="lg:pt-10 pt-3 w-8/12">
        ...
        <div className="flex gap-10 ml-4">
          <button class="flex bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-2 px-4 rounded">
            <p className="flex gap-2">
              Github <GrGithub className="mt-1" />
            </p>
          </button>
          <button class="bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-2 px-4 rounded">
            <p className="flex gap-2">
      ...
      <div className="ml-auto w-4/12 lg:py-12 py-7">
        <img src={photo} className="rounded-full border" alt="profile" />
      </div>
    </div>
  );
}
